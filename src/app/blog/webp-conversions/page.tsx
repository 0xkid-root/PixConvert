...
export const metadata: Metadata = {
  title: 'WebP Conversion Guide - Modern Image Format Benefits',
  description: 'Learn about WebP image format and how to convert to/from WebP with our free online tool. Discover benefits of WebP over JPG and PNG.',
  keywords: 'webp converter, webp format, webp to jpg, webp to png, jpg to webp, image compression',
  openGraph: {
    title: 'WebP Conversion Guide - Modern Image Format Benefits',
    description: 'Learn about WebP image format and how to convert to/from WebP with our free online tool. Discover benefits of WebP over JPG and PNG.',
    type: 'article',
  ...
  alternates: {
    canonical: 'https://cloudeconvert.vercel.app/blog/webp-conversions',
  }
};
